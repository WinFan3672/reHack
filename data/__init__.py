...
PROGRAMS = [
        ...
        Program("connect", 1.0, "", game.programs.connect.main, True, classPlease=True),
        Program("history", 1.0, "", game.programs.history,True, classPlease = True),
        Program("note",  1.0, "", game.programs.note, True, classPlease=True),
        ...
        Program("tor", 1.0, "", programs.tor, True, classPlease=True),
        ...
        Program("account", 1.0, "", programs.accountList, True, classPlease=True),
        Program("bankhack", 1.0, "Tool for brute-forcing a bank PIN", programs.bankhack, price=1000, classPlease=True),
        Program("tormail", 1.0, "", programs.tormail, True, classPlease=True),
        Program("date", 1.0, "", programs.date, True, classPlease=True),
        ]
